        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center" style="margin-top:20px;">
              <h1 class="text-white font-weight-bold" style="font-size: 40px; ">Hỗ trợ tiếp cận đến công việc của bạn</h1>
            </div>
            <form action="{{route('home.joblistings.search')}}" method="post" class="search-jobs-form">
            @csrf
              <div class="row mb-5">
